    ...
    for i in _cici_.split(" "):
        if len(i)<3:
            ...
            if len(i)==3 or len(i)==4 or len(i)==5:
            	_anggaxd_.append(i+"12")
                _anggaxd_.append(i+"123")
                _anggaxd_.append(i+"12345")
                _anggaxd_.append(i+"1234")
                _anggaxd_.append(i+"09")
                _anggaxd_.append(i+"1122")
                _anggaxd_.append(i+"123456")
            elif len(i)>=6:
                _anggaxd_.append(i)
                _anggaxd_.append(i+"12")
                _anggaxd_.append(i+"123")
    ...
    for i in _cici_.split(" "):
        if len(i)<3:
            ...
            if len(i)==3 or len(i)==4 or len(i)==5:
                ...
                _anggaxd_.append(i+"09")
    _anggaxd_.append(_cici_.lower())
    _anggaxd_.append("akusayangkamu")
    _anggaxd_.append("rahasia")
    _anggaxd_.append("kontol")
    _anggaxd_.append("anjing")
    _anggaxd_.append("katasandi")
    _anggaxd_.append("bangsat")
    _anggaxd_.append("sayang")
    return _anggaxd_
